...
### [sort2] 2-1. 브라우저 멀티미디어 에디터의 상태 구조
...
### [sort2] 2-2. A 프로젝트 작업이 B 프로젝트에 붙는 시간 순서
...
## [sort1] 3. FFmpeg만의 문제가 아니었던 이유

### [sort2] 3-1. 늦게 끝난 작업이 현재 프로젝트에 쓰는 문제
...
### [sort2] 3-2. await 이후 현재 store를 다시 읽는 문제
...
### [sort2] 3-3. 동시성 제어와 stale result 방지는 다른 문제
...
## [sort1] 4. 유효성을 판단하는 기준 만들기

### [sort2] 4-1. useEffect cleanup에서 얻은 힌트
...
### [sort2] 4-2. localProjectId만으로 부족했던 이유
...
### [sort2] 4-3. epoch 아이디어를 어디서 얻었는가
...
### [sort2] 4-4. epoch로 runtime 세대를 구분하기
...
### [sort2] 4-5. snapshot으로 시작 시점 데이터를 고정하기
...
### [sort2] 4-6. AbortSignal로 이전 작업에 취소 신호 보내기
...
### [sort2] 5-2. ProjectRuntimeCoordinator
...
### [sort2] 6-1. 프로젝트 전환 시 runtime을 교체하는 흐름

### [sort2] 6-2. FFmpeg job이 파일을 격리하는 흐름

## [sort1] 7. 변경 결과와 남은 구멍
...
### [sort2] 7-4. thumbnail cache의 write guard
