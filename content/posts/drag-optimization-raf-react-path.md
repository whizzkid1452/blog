---
title: '[Part 1.] React 경로를 줄이고 한 프레임에 한 번만 그리기'
...
## [sort1] 4. 여러 리전 신호를 한 번의 그리기로 묶기
...
## [sort1] 5. React state만 줄여서는 부족했던 이유
...
## [sort1] 6. Canvas 다시 그리기를 React 밖에서 직접 실행하기
...
## [sort1] 7. drag visual을 React 밖으로 꺼내기
