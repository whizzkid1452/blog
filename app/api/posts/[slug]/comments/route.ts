import { createCommentSchema, postSlugSchema } from '@/lib/comments/comment-schema';
import type { CommentRepository } from '@/lib/comments/comment-types';
import { getSupabaseCommentRepository } from '@/lib/comments/supabase-comment-repository';
...
interface CommentRouteHandlers {
